...
function Products() {
  ...
  async function fetchData() {
    try {
      const response = await axios.get(`${API_URL}/api/v1/categories/${id}/products/`);
          ...
          <Col key={product.name}>
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text className='hide-scrollbar ' style={{ maxHeight: "50px" }}> {product.description}</Card.Text>
